...
//=============================================================================
/**
 * CoordActController is a concrete controller that excites muscles in response
 ...
 * @version 1.0
 */
class OSIMPLUGIN_API CoordActController : public Controller {
OpenSim_DECLARE_CONCRETE_OBJECT(CoordActController, Controller);
...
//=============================================================================
	...
	*/
	CoordActController(double Kp, double Kv, double AngleThresh, double VelThresh);
	

	/** Compute the controls for actuators (muscles)
	 *  This method defines the behavior for CoordActController controller 
	 *
...
private:
	...
	//=============================================================================
};	// END of class CoordActController

}; //namespace
//=============================================================================
//=============================================================================

#endif // OPENSIM_CoordActController_H_
